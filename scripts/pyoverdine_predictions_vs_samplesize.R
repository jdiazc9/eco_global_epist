...
ggsave(myplot,
       filename = '../plots/pyoverdine_predictions_vs_samplesize.pdf',
       device = 'pdf',
       dpi = 600,
       width = 150,
       height = 90,
...
ggsave(filename = '../plots/pyoverdine_predictions_vs_samplesize_inset1.pdf',
       device = 'pdf',
       dpi = 600,
       width = 80,
       height = 50,
...
ggsave(filename = '../plots/pyoverdine_predictions_vs_samplesize_inset2.pdf',
       device = 'pdf',
       dpi = 600,
       width = 80,
       height = 50,
